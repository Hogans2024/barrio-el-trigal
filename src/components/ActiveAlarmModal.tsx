        ...
        <div className="flex-1 flex flex-col sm:flex-row sm:overflow-hidden">
          ...
          <div className="order-1 sm:order-none w-full sm:w-[420px] px-4 sm:px-8 pt-1 pb-3 flex flex-col justify-between bg-black/20 relative sm:overflow-y-auto">
            ...
            <button
              ...
              className={`w-[90%] mx-auto mt-3 py-2.5 tall:py-3 sm:py-2.5 rounded-xl font-bold font-sans text-sm tall:text-base sm:text-sm transition-all duration-300 active:scale-95 flex items-center justify-center space-x-2 shadow-lg cursor-pointer ${
                step === 'enter_activation_phone'
                  ? enteredPin.length >= 1
